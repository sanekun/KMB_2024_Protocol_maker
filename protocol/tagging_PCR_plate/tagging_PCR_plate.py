...
metadata = {
    'protocolName': 'tagging PCR plate premix preparation',
...
def run(protocol: protocol_api.ProtocolContext):
    ...
    tag_primer_plate = protocol.load_labware("bioneer_96_wellplate_300ul", 2)
    destination_plate = protocol.load_labware("nesteppendrf_96_wellplate_150ul", 1)
    ...
    #Set the Liquids
    reverse_tag = tag_primer_plate.rows()[0][0:8] #8 of 12
