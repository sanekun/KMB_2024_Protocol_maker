        ...
        for i in PARAMETERS["Plates"].keys():
            ...
            if plate["type"] != "TF":
                ...
                for sample in unique_sample:
                    ...
                    p20.distribute(spotting_volume, src, dest, new_tip="once", touch_tip=True, trash=not debug)
        tc_mod.deactivate()
