...
def run(protocol: protocol_api.ProtocolContext):
    ...
    #============= PROTOCOL STEPS
    ## Functions
    def enzyme_transfer(pipette, volume, src, dest, delay_second=0, asp_rate=None, dis_rate=None, mix_after=False):
        if asp_rate != None:
    ...
    for dest in mag_well:
        enzyme_transfer(p20_sin, 12.5, water, dest, 0, 20, 20, mix_after=(3, 15))
